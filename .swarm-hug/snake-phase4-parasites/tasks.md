...
- [B] (#14) Prevent post-spawn overlap regressions by excluding the active parasite pickup tile from `Food.respawn()` and Molten Core lava-pool spawn candidate selection.
- [B] (#15) Add regression tests proving food respawns and Molten Core lava spawns never occupy a tile that already contains an active parasite pickup.
