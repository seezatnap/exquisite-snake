...
## Follow-up tasks (from sprint review)
- [C] (#16) Complete runtime pickup consumption in `MainScene` by consuming when the snake head enters a pickup cell, removing the consumed pickup sprite, and applying inventory/FIFO plus parasites-collected updates from `ParasiteManager`.
