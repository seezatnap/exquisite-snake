...
- [A] (#2) Implement parasite pickup spawning so pickups appear occasionally on random empty cells only, never overlap snake/food/obstacles, and use a render identity visually distinct from normal food [5 pts] (blocked by #1)
