...
- [A] (#7) Add emergency teleport safety handling: trigger flash VFX and disable collisions for ~0.5 seconds after forced teleport, then reliably restore collision checks [5 pts] (blocked by #6)
