...
- [A] (#5) Implement body threading logic so segments transit one-by-one through the linked portals with maintained segment order and smooth continuity [5 pts] (blocked by #4)
...
- [A] (#9) Implement nearby tile distortion around active portals using barrel shader or scale-effect fallback, with tunable radius/intensity and cleanup on collapse [5 pts] (blocked by #8)
