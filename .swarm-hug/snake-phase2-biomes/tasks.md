...
- [B] (#9) Add mechanic-linked visual elements (Molten lava pool visuals and Void center vortex) with proper render layering relative to snake, food, and arena tiles [5 pts] (blocked by #4, #5, #7)

## HUD & Game Over

- [C] (#10) Update HUD biome indicator to show current biome name and icon, refreshing on each transition for all four biome states [5 pts] (blocked by #2, #7)
...
- [C] (#14) Add GameOver component rendering test to verify the biomes-visited stat displays the correct count from bridge state (blocked by #11)
