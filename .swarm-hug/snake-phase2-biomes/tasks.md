...
- [x] (#9) Add mechanic-linked visual elements (Molten lava pool visuals and Void center vortex) with proper render layering relative to snake, food, and arena tiles [5 pts] (blocked by #4, #5, #7) (B)

## HUD & Game Over

- [x] (#10) Update HUD biome indicator to show current biome name and icon, refreshing on each transition for all four biome states [5 pts] (blocked by #2, #7) (C)
...
## Follow-up tasks (from sprint review)
- [x] (#17) Mark task #16 as complete — task #14 (GameOver biome-visited rendering tests) was fully delivered in sprint 4 (A)
